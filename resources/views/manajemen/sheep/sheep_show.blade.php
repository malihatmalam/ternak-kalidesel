    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                ...
                @endif
                <h2 class="page-title">Stock Hewan Ternak <b> Domba </b></h2>
                <div class="row">
                        ...
                        <div class="panel panel-headline">
                            <div class="panel-heading">
                                ...
                                @if ($livestock_jenis == 'cow')
                                    <img src="{{ asset('admin/assets/images/Sapi.jpg') }}" style="width: 100px"> <strong> :
                                        Sapi</strong>
                                @endif
                                @if ($livestock_jenis == 'goat')
                                    <img src="{{ asset('admin/assets/images/Kambing.jpg') }}" style="width: 100px">
                                    <strong> : Kambing</strong>
                                @endif
                                @if ($livestock_jenis == 'sheep')
                                    <img src="{{ asset('admin/assets/images/Domba.jpg') }}" style="width: 100px"> <strong>
                                        : Domba</strong>
                                @endif
                            </div>
                        </div>
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title">Tabel Stock <b> Domba </b></h3>
                </div>
                <div class="panel-body">
