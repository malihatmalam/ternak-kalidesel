    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="metric">
                                        ...
                                        <br>
                                        <div>
                                            <h3 class="panel-title">Tambah Konsultasi Penyakit Hewan Ternak</h3>
                                            <br>
                                            <form action="{{ route('complaint.create') }}" method="GET">
                                                @csrf
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Konsultasi Penyakit Ternak yang <strong>Dijawab</strong></h3>
                        {{-- <p class="panel-subtitle">Hari ini</p> --}}
                    </div>
                    <div class="panel-body">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Konsultasi Penyaki Ternak yang <strong>Belum Dijawab</strong></h3>
                        {{-- <p class="panel-subtitle">Hari ini</p> --}}
                    </div>
                    <div class="panel-body">
                            ...
                            <tbody>
                                @foreach ($complaints as $complaint)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('diagnosis.detail', $complaint->code) }}"
                                                class="btn btn-info">
                                                Detail
                                            </a>
                                            {{-- <form action="{{ route('livestock.mati', $animal->id) }}" method="POST">
