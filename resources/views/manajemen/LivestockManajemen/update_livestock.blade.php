                    ...
                    <div class="panel-body">
                        <form action="{{ route('livestock.update', $livestock->id) }}" method="post"
                                ...
                                <div class="container">
                                    <label class="fancy-radio">
                                        <input name="jenis_kelamin" value="male" type="radio"
                                            {{ $livestock->jenis_kelamin == 'male' ? 'checked' : '' }}>
                                        <span><i></i>Jantan</span>
                                    </label>
                                    <label class="fancy-radio">
                                        <input name="jenis_kelamin" value="female" type="radio"
                                            {{ $livestock->jenis_kelamin == 'female' ? 'checked' : '' }}>
                            ...
                            <input type="text" class="form-control" name="warna" placeholder="Warna hewan ...."
                                value="{{ $livestock->warna }}">
                            <br>

                            <!-- tanggal lahir -->
                            <label for="tgl-lahir-hewan" class="col-sm-3 col-form-label"> Tanggal Lahir </label>
                            <input type="text" class="form-control" name="tgl_lahir"
                                placeholder="Tanggal lahir hewan ...." value="{{ $livestock->tgl_lahir }}">
                            <br>

                            <!-- deskripsi -->
                            <label for="deskripsi-hewan" class="col-sm-3 col-form-label"> Deskripsi Hewan </label>
                            <textarea class="form-control" placeholder="Deskripsi hewan..." name="description" rows="4"
                                value="{{ $livestock->description }}"></textarea>
                            <br>
                            ...
                            <input type="text" class="form-control" name="berat" data-type="weight"
                                value="{{ $livestock->berat }} Kilogram" placeholder="Berat hewan .... (Kilogram)">
                            <br>
